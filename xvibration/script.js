...
function updateGamepadStatus() {
  ...
  if (connectedGamepad) {
    ...
    gamepad = null;
    document.getElementById('controller-status').textContent = 'Controller disconnected. 1. Check if controller is connected to your device   2. Press any button on the controller to complete connection. ';
